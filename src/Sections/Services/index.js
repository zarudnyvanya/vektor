    ...
    <ServiceSection id="services">
      ...
      <Content ref={addToRefs}>
        <TextBlock
          ...
          subText={
            <h5>
              Вы можете приобрести замороженные полуфабрикаты по выгодной цене. У нас большой
              ассортимент продуктов и товаров. <br />
              Доставляем по всей Ростовской области, Краснодарскому краю и другим регионам
            </h5>
          }
        />
      ...
      <Content>
        <TextBlock
          ...
          subText={
            <h5>
              Для удобства выбора все позиции в каталоге разделены на тематические категории. В
              наличии мясо и рыба, овощи и фрукты, молоко и колбасные изделия. Также мы продаем
              напитки, сладости и множество других товаров.
            </h5>
          }
        />
