...
const Services = () => {
  ...
  return (
    <ServiceSection id="services">
      <Background style={{ marginBottom: 100 }} ref={ref}>
        ...
        <TextBlock
          ...
          subText={
            <ul style={{ maxWidth: '80%' }}>
              ...
              <li>Доставляем по всей Ростовской области, Краснодарскому краю и другим регионам</li>
            </ul>
          }
        />
      ...
      <Content>
        <TextBlock
          ...
          subText={
            <h5>
              В наличии мясо и рыба, овощи и фрукты, молоко и колбасные изделия. Также мы продаем
